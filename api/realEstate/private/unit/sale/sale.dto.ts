...
import type {HandoverPackage, SaleHandoverChecklistItem} from "../../handoverPackage/handoverPackage.dto";
...
export type Sale = DeletedData & OwnershipData & LifeCycleData & {
    ...
    handoverChecklistItems?: SaleHandoverChecklistItem[];
    handoverConfigs?: HandoverPackage[];
