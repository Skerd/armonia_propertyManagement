...
export function editUnitCostFormSchema(languageCode: string, form: any = null) {
    ...
    return z.object({
        ...
        constructorRef: z.preprocess((v) => (v === "" ? undefined : v), isObjectIdZod(L("constructor"), languageCode).optional().nullable()),
        boqItem: z.preprocess((v) => (v === "" ? undefined : v), isObjectIdZod(L("boqItem"), languageCode).optional().nullable()),
        costCommitment: z.preprocess((v) => (v === "" ? undefined : v), isObjectIdZod(L("costCommitment"), languageCode).optional().nullable()),
