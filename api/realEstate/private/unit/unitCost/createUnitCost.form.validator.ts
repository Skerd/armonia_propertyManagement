...
export function generateZodCreateUnitCostFormSchema(languageCode: string, form: any = null) {
    ...
    return z
        .object({
            ...
            constructorRef: z.preprocess(emptyToUndef, isObjectIdZod(L("constructor"), languageCode).optional()),
            boqItem: z.preprocess(emptyToUndef, isObjectIdZod(L("boqItem"), languageCode).optional()),
            costCommitment: z.preprocess(emptyToUndef, isObjectIdZod(L("costCommitment"), languageCode).optional()),
